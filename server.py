...
server.register_function(verMao)
server.register_function(verMesa)
server.register_function(verBaralho)
server.register_function(jogadoresProntos)
server.register_function(iniciarRodada)
server.register_function(tacarCarta)
server.register_function(obterVezJogador)
server.register_function(verPlacarSubRodada)
server.register_function(obterVencedorSubRodada)
